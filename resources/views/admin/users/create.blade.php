                    ...
                    <div class="nav_tabs_content">
                        <div id="data">
                            ...
                            <label class="label">
                                ...
                                <input type="text" name="name" placeholder="Nome Completo" value="{{ old('nome') }}"/>
                            </label>
                                ...
                                <label class="label">
                                    ...
                                    <select name="civil_status">
                                        <optgroup label="Cônjuge Obrigatório">
                                            <option value="married" {{ old('married') == 'married' ? 'checked' : '' }}>Casado</option>
                                            <option value="separated" {{ old('separated') == 'married' ? 'checked' : '' }}>Separado</option>
                                        </optgroup>
                                        <optgroup label="Cônjuge não Obrigatório">
                                            <option value="single" {{ old('single') == 'married' ? 'checked' : '' }}>Solteiro</option>
                                            <option value="divorced" {{ old('divorced') == 'married' ? 'checked' : '' }}>Divorciado</option>
                                            <option value="widower" {{ old('widower') == 'married' ? 'checked' : '' }}>Viúvo</option>
                                        </optgroup>
                                    </select>
                                </label>
                                ...
                                <div class="app_collapse_content d-none content_spouse">
                                    ...
                                    <label class="label">
                                        ...
                                        <select name="type_of_communion" class="select2">
                                            <option value="Comunhão Universal de Bens" {{ old('type_of_communion') == 'Comunhão Universal de Bens' ? 'checked' : '' }}>Comunhão Universal de Bens
                                            </option>
                                            <option value="Comunhão Parcial de Bens" {{ old('type_of_communion') == 'Comunhão Parcial de Bens' ? 'checked' : '' }}>Comunhão Parcial de Bens</option>
                                            <option value="Separação Total de Bens" {{ old('type_of_communion') == 'Separação Total de Bens' ? 'checked' : '' }}>Separação Total de Bens</option>
                                            <option value="Participação Final de Aquestos" {{ old('type_of_communion') == 'Participação Final de Aquestos' ? 'checked' : '' }}>Participação Final de
                                                Aquestos
                                            </option>
                                        </select>
                                    </label>
                                    ...
                                    <div class="label_g2">
                                        <label class="label">
                                            ...
                                            <select name="spouse_genre">
                                                <option value="male" {{ old('spouse_genre') == 'male' ? 'checked' : '' }}>Masculino</option>
                                                <option value="female" {{ old('spouse_genre') == 'female' ? 'checked' : '' }}>Feminino</option>
                                                <option value="other" {{ old('spouse_genre') == 'other' ? 'checked' : '' }}>Outros</option>
                                            </select>
                                        </label>
